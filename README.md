...
```json
{
  "mcpServers": {
    "skills-whm-pro": {
      ...
      "url": "http://mcp.example.com:3200/mcp",
      "headers": {
...
3. Configure endpoint: `http://mcp.example.com:3200/mcp`
...
```bash
curl http://mcp.example.com:3200/health
```
...
```json
{
  "mcpServers": {
    "whm-pro": {
      "httpUrl": "http://mcp.example.com:3200/mcp",
      "headers": {
        "x-api-key": "YOUR_API_KEY"
      },
      "timeout": 30000
